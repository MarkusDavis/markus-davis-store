  ...
  return (
    <header className="sticky top-0 z-50">
      <div className="flex items-center p-1 flex-grow py-2 bg-light-primary dark:bg-dark-secondary">
        ...
        <div className="hidden sm:flex items-center h-10 rounded-md flex-grow cursor-pointer hover:bg-light-secondary dark:hover:bg-dark-primary">
          <input
            className="p-2 h-full w-6 flex-grow flex-shrink rounded-l-md focus:outline-none px-4 bg-transparent dark:text-white dark:placeholder:text-white placeholder:text-black"
            type="text"
      ...
      <div className="flex items-center space-x-3 p-2 pl-6 bg-dark-primary text-sm">
